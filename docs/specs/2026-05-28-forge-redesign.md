...
- **Phase 0 baseline:** the initial scaffold lived under `0.1.0/` (commit `c5bf9fc`). Phase 1 finalizer (PR 1f) renamed to `0.2.0/`. Phase 2 finalizer (PR 2e) renamed to `0.3.0/`. Current spine: [`../../0.3.0/skills/forge/SKILL.md`](../../0.3.0/skills/forge/SKILL.md).
...
```
forge-skills/
  <version>/                   ← currently 0.3.0 (Phase 2 complete); originally 0.1.0
